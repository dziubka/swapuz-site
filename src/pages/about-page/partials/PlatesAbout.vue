<template>
  <div class="plates-about container">
    <div class="plates-about-items">
      <div
      ...
      >
        <div class="item-text">
          <h3 class="item-text_title">
            {{ item.title }}
          </h3>
          <div class="item-text_desc">
            {{ item.desc }}
          </div>
        </div>
        <div>
...
<style lang="scss">
@import "../../../assets/styles/pages/about-page/plates-about";
</style>