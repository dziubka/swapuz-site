  ...
  <div class="hero-about">
    <div class="container">
      <div class="hero-about-content">
        <div class="hero-about-content-text">
          <h1 class="title">
        ...
        <div class="hero-about-content-img">
          <img src="../../../assets/img/about-hero-img.png" class="hidden" alt="">
          <img src="../../../assets/img/about-hero-mob.png" class="show" alt="">
        </div>
      </div>
  </div>
  </div>
...
<style lang="scss">
@import "../../../assets/styles/pages/about-page/hero-about";
</style>